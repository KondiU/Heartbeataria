...
{
    public class KFCChairTile : ModTile
    {
        ...
        public override void MouseOver(int i, int j) => FurnitureHelper.MouseOver(i, j, ModContent.ItemType<Content.Items.Placeable.KFCChair>());
    }
}