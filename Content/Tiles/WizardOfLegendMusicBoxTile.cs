...
namespace XDContentMod.Content.Tiles {
	public class WizardOfLegendMusicBoxTile : ModTile {
		...
		public override void MouseOver (int i, int j) {
			...
			player.cursorItemIconID = ModContent.ItemType<Items.Placeable.WizardOfLegendMusicBox>();
		}
	}
}