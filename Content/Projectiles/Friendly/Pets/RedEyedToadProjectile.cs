...
{
    public class RedEyedToadProjectile : ConsolariaPet
	{
        ...
        public override void SetStaticDefaults () 
		{
            ...
            ProjectileID.Sets.CharacterPreviewAnimations[Projectile.type] = ProjectileID.Sets.SimpleLoop(0, Main.projFrames[Projectile.type], 9)
				.WithOffset(-10, -20f)
        ...
        public override void AI () 
		{
            ...
            if (!player.dead && player.HasBuff(ModContent.BuffType<Content.Buffs.RedEyedToadBuff>()))
