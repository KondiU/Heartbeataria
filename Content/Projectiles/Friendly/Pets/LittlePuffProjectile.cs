...
{
	public class LittlePuffProjectile : ModProjectile
	{
...
//			Projectile.netImportant = true;
		...
		public override void AI() 
		{
			...
			if (!player.dead && player.HasBuff(ModContent.BuffType<Content.Buffs.LittlePuffBuff>())) 
